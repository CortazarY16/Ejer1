    ...
    <section>
        <form method="POST" action="resumen.php">
            <table border="1" width="700" cellspacing="10" cellpadding="0">
                ...
                <tr>
                    <td>¿Cómo se siente a nivel de seguridad en la ciudad de Lima?</td>
                    <td><?php echo $pregunta1; ?></td>
                </tr>
                <tr>
                    <td>¿Qué tipo de delito cree usted que es el más común en su zona de residencia?</td>
                    <td><?php echo $pregunta2; ?></td>
                </tr>
                <tr>
                    <td>¿Generalmente qué día cree usted que ocurre más incidencias?</td>
                    <td><?php echo $pregunta3; ?></td>
                </tr>
                <tr>
                    <td>¿Cuáles cree usted que deben ser las medidas que las autoridades deben aplicar para combatir estas incidencias?</td>
                    <td><?php echo $pregunta4; ?></td>
                </tr>
                <tr>
                    <td>¿Usted conoce las medidas que implementa la policía del Perú para disminuir la delincuencia?</td>
